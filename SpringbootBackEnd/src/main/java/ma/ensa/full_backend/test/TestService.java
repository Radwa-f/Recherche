...
public class TestService {
    ...
    private List<Chambre> createChambers() {
        ...
        chambers.add(createChambre(TypeChambre.SUITE, 950.0f));
        chambers.add(createChambre(TypeChambre.SINGLE, 100.0f));
        chambers.add(createChambre(TypeChambre.SINGLE, 1200.0f));
        chambers.add(createChambre(TypeChambre.DOUBLE, 1500.0f));
        chambers.add(createChambre(TypeChambre.DOUBLE, 1800.0f));
        chambers.add(createChambre(TypeChambre.SUITE, 2500.0f));
        chambers.add(createChambre(TypeChambre.SUITE, 9500.0f));
        chambers.add(createChambre(TypeChambre.SINGLE, 1010.0f));
        chambers.add(createChambre(TypeChambre.SINGLE, 1210.0f));
        chambers.add(createChambre(TypeChambre.DOUBLE, 1510.0f));
        chambers.add(createChambre(TypeChambre.DOUBLE, 1810.0f));
        chambers.add(createChambre(TypeChambre.SUITE, 2510.0f));
        chambers.add(createChambre(TypeChambre.SUITE, 9510.0f));
